 ...
 * Author: [Bakhronjon Hamzaev]
 * Student ID: [241ADB017]
 * Description:
...
// TODO: Define struct Student with fields: name (char[]), id (int), grade
...
int main(void) {
  ...
  strcpy(student1.name, "Bakhronjon");
  student1.id = 241;
  student1.grade = 10;

  strcpy(student2.name, "Ilyas");
  student2.id = 231;
  student2.grade = 10;
